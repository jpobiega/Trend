...
if [[ -z "$IAM_STACK" ]] ; then IAM_STACK="eks-iam-stack"; fi
if [[ -z "$VPC_STACK" ]] ; then VPC_STACK="eks-vpc-stack"; fi
if [[ -z "$BASTION_STACK" ]] ; then BASTION_STACK="eks-bastion-stack"; fi
if [[ -z "$EKS_STACK" ]] ; then EKS_STACK="eks-stack"; fi
